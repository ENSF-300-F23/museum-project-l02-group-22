...
VALUES ('Ellen Maurice (1578–1626)', 'Marcus Gheeraerts the Younger ', 'Painting', '1597', 'Potrait of Ellen Maurice', 'Welsh or English', 'Late Renaissance/Early Baroque', 'Owned'),
       ...
       ('Trompe l’Oeil Still Life with Flower Garland and Curtain', 'Adriaen van der Spelt, Frans van Mieris the Elder', 'Painting', '1658', 'Painting of flower', 'Dutch', 'Baroque', 'Owned'),
       ...
       ('Esclave rebelle', 'Michelangelo', 'Sculpture', '1513', 'Sculpture of a rebellious slave', 'Italian', 'Renaissance', 'Borrowed'),
...
VALUES (1, 2016-02-23, 'On Display', 13,757.50),
	   (2, 2016-11-09, 'On Display', 94,940.94),
       (3, 2003-01-15, 'On Display', 94,003.46),
       (4, 2015-09-23, 'Stored', 12,306.57),
       (5, 2008-08-19, 'On Loan', 43,186.76),
       (6, 2018-12-08, 'On Display', 17,749.13),
       (7, 2014-05-13, 'On Loan', 15,834.11),
       (8, 2006-10-24, 'Stored', 1,255.04),
       (9, 2007-06-20, 'Stored', 71,044.99),
       (10, 2018-01-15, 'On Loan', 10,378.12),
       (11, 2012-02-08, 'On Display', 18,837.73),
       (12, 2016-11-11, 'Stored', 55,834.45),
       (13, 2012-07-20, 'On Loan', 88,920.92),
       (14, 2016-02-23, 'Stored', 21,154.15),
       (15, 2006-04-14, 'Stored', 98,361.32),
       (16, 2006-06-08, 'On Loan', 97,747.02),
       (17, 2010-10-01, 'On Display', 91,668.53),
       (18, 2012-01-26, 'On Display', 10,064.86);
...
VALUES (19, 'MASTERPIECES OF THE LOUVRE', 2015-06-15, 2016-01-10),
	   (20, 'MASTERPIECES OF THE LOUVRE', 2016-09-12, ''),
...
VALUES ('Marcus Gheeraerts the Younger', '1561', '1635/36', 'Bruges, Belgium', 'Baroque', 'Realism', 'Marcus Gheeraerts was a Flemish artist working at the Tudor court, described as "the most important artist of quality to work in England in large-scale between Eworth and van Dyck" He was brought to England as a child by his father Marcus Gheeraerts the Elder, also a painter.'),
       ...
       ('Leonardo da Vinci', '1452', '1519', 'Anchiano, Italy', 'Renaissance', 'Potrait', 'Leonardo di ser Piero da Vinci was an Italian polymath of the High Renaissance who was active as a painter, draughtsman, engineer, scientist, theorist, sculptor, and architect.'),
